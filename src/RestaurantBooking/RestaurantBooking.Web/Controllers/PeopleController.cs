...
namespace RestaurantBooking.Web.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Phone")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Phone")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
